...
export const PRESETS: Preset[] = [
  ...
  },
  {
    ...
    note: '~130 mm, 6 h, tanks full. Reconstructed.',
    params: {
      ...base,
      rain: { ...base.rain, profile: 'triangular', peak_mm_hr: 43, duration_hr: 6, peak_at_hr: 3, series_mm_hr: [], scale: 1 },
      hours: 18, drainage_failure: 0.5, lake_fill: 0.9, antecedent_wetness: 0.8,
    },
  },
]
